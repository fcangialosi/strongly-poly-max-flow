...
\section{Introduction}\label{sec:intro}
	...
	\frank{Do we want to add a related work section? e.g. weakly-polynomial,
	fat-graph, cycle-cancelling, etc.}
...
\vspace{0.5cm}
	...
	\frank{We mentioned at one point changing the word label to something more intuitive. Let's decide.}
...
%    \end{proof}
    ...
    {\nexists\ \text{plentiful}\ i \in \vsink}
		...
		\frank{why do we want to stop at excess of 1? why not more than that? is it
