...
\item Find contractible edges and contract until a stopping condition is met
	(\emph{cf.} Section \ref{sec:progress} Case i) in one of the following ways:\frank{how does it choose
...
non-zero excess on every node. \katie{talk about relaxation and delta-conservative pairs}
