...
%	preserves the objective and constraints.
	...
	There is one dual variable for every vertex. Thus the number of edge
    contractions is at most $n - 1$ before the graph is left with a single vertex.
    Put differently, a spanning tree of tight edges encodes all the information
    necessary to encode a dual optimal solution.
