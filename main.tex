...
\item Find an initial feasible flow $\bar{f}$ and set the initial $\Delta$ to max $e_i^\mu$ for $i \in V\setminus T$\frank{why this value?}
...
\item Find contractible edges and contract until stopping condition is met
	(\ref{sec:contract}) \frank{what's the stopping condition? is it not specific
