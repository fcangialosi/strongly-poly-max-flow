...
%    \end{proof}
	...
	become tight and add some insight in the text about this.}
		\frank{Want to ensure that all times the excess is bounded. Dual mandate
		thing. Keep the excess and deficit bounded, other one is make b really big.
	Every time they create excess they have to cancel it off. Add a todo for david
about massaging this out in 5.2.}
