...
\begin{center}
    ...
    "Abundant arc" might not appear in strongly polynomial number of steps \cite{Radzik2004} & Continuous Scaling Method  \\ \hline
    ...
    Augmentation along highest gain paths introduce flow generating cycles; must run cycle-canceling algorithms in every scaling phase \cite{} &  \\
    \hline
    \end{tabular}
\end{center}
...
identifying contractible arcs and then contracting them until a dual optimal
