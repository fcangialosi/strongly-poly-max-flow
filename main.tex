...
\label{sec:motivate}
	...
	Combining the previous two sections, the heart of both algorithms is a process
	...
	differences between the two algorithms is in how they find contractible edges, which
	we will describe in Sections~\ref{sec:2013} and~\ref{sec:2017}.

	This process repeats until either (1) the graph
