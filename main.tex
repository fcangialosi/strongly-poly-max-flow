...
have a contractible edge adjacent to it.\katie{We might want to at least sketch
...
While finding and contracting edges, the algorithm maintains several sets as defined below:
	...
	\end{align*}
	\katie{Why is $D$ constructed in this way?}
...
\katie{It might be helpful to refer to this as edges crossing the V-R cut}
...
to zero\katie{again talking about cut might be clearer here}. This subroutine can speed up the finding the contractible arc process
...
$V \setminus R$ to $t$ continues until the graph is contracted into one node. \katie{mention expanding and computing primal or ref section 3 for this?}
