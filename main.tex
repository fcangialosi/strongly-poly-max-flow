...
\vspace{0.5cm}
  ...
  Although the algorithms focus on solving the dual first, they maintain some solution to the primal throughout, and thus it often makes sense to talk about a pair of primal-dual solutions $(f,u)$.
  \begin{definition}
