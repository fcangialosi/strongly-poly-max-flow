...
For the analysis, we define a \textit{shrinking iteration} as an iteration the while loop in which at least one node is removed from the set R of reachable nodes. This can occur from auge
...
where you can definitely send it}
    ...
    by augmenting one unit of flow at a time along tight paths. Again we focus
