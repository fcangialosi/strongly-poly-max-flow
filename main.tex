...
\item Run a cycle-canceling algorithm, then compute an initial conservative labeling, $\mu$.
...
\katie{What does it mean to modify it with respect to u?}
...
improve the balance of excess across the graph. After augmentation,
