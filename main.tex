...
\label{sec:motivate}
    ...
    Given optimal dual labels \katie{(solutions)? should we mention that labels are just another word for solution to dual} $\mu$, consider the primal problem relabeled by $\mu$.
