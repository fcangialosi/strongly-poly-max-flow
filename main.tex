...
\section{Preliminaries}\label{sec:prelim}
	...
	across the edges. We also make the assumption that m $\geq$ n. Although we have typically seen flow constraints defined in terms of
...
%    \end{figure}
	...
	\begin{proof}
		...
		(\emph{cf.} \cite{Schrijver2002}, Corollary 11.2j),
	...
	assumption (i) of Theorem \ref{thm:2017-contraction}. When it encounters
...
%	constraint becomes tight.
	...
	\subsection{Analysis}
	We now present some invariants that the algorithm preserves during each
	epoch. These will allow us to prove that it finds a plentiful node in
	strongly polynomial time, and that the overall algorithm produces a correct
	optimal solution.
    \begin{lemma}
...
\iffalse
    ...
    \subsection{Scaling and Rounding} \label{sec:2017-rounding}
