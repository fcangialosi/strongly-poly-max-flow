...
%		\end{align*}  
%	\end{minipage}
%	$\xrightarrow{\hspace*{0.25cm}\mu=\mu\hspace*{0.25cm}}$\hfill
%		\hspace{-1.35cm}
...
%	\end{minipage}
    ...
    &   &\mu_t &\in \R_{++}
    \end{alignat*}
    where $\R_{++}$ denotes the positive numbers.
...
\section{Motivating Ideas and Techniques}
    ...
    consists of alternating scaling and augmentation phases. In the scaling phases, the
