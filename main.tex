...
The full set of proofs for this runtime analysis in the original paper \cite{article} is lengthy and complex, so in this section we instead provide insight about the few key ideas that lead to a strongly polynomial bounded runtime. 
