...
\begin{claim}
	...
	strictly increases $|\biu|$. For all other nodes, $|\biu|$ remainds unchanged.
\end{claim}
\begin{proof}
...
In summary, we have shown that this algorithm strictly increases $\biu$ towards
the definition of a plentiful node, and thus 
Since we have proven that our conditions required in the rest of the analysis
($f_u$ integral and $(f,u)$ a fitting pair) are maintaied 
