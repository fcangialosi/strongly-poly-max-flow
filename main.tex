...
\label{sec:motivate}
    ...
    and it preserves the dual objective and other constraints.
...
%	preserves the objective and constraints.
	...
	before the graph is left with a single vertex. The set of guaranteed-tight edges identified
	...
	graph, with a primal objective value of zero. By strong duality, any feasible dual
...
%    Given optimal dual labels $\mu$, consider the primal problem relabeled by $\mu$.
    ...
    the tight edges---$\giij = \gij\mu_i/\mu_j = 1$
