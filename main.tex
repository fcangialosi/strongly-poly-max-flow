...
%
	...
	\frank{Should right-hand side use $i$ instead of $j$ too?}
...
tight paths (highest-gain paths) from $H$ to $L$. This redistributes excess
so as to balance it out. If the algorithm augments,
...
This gives a total runtime of $O(n^3m^2logn)$ (all other operations including initialization
